...
@dynamic_per_token_scaled_fp8_quant.register_input_generator  # type: ignore[misc]
...
@dynamic_per_token_scaled_fp8_quant.register_config_picker  # type: ignore[misc]
