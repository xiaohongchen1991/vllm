...
@scaled_mm.register_input_generator  # type: ignore[misc]
def generate_scaled_mm_inputs() -> dict[str, tuple[Any, ...]]:
...
@scaled_mm.register_config_picker  # type: ignore[misc]
def pick_scaled_mm_config(args: tuple[Any, ...], config_keys: list[str]) -> str | None:
    ...
    a, b, scale_a, scale_b, out_dtype, bias = args
