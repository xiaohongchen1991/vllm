    ...
    for num_tokens, hidden_size in product(num_tokens_list, hidden_size_list):
        try:
            ...
            helion_kernel = lambda: helion_custom_op(
                output.clone(), input, scale.clone()
            )
...
if __name__ == "__main__":
    # autotune(dynamic_per_tensor_scaled_fp8_quant, True)
    benchmark(dynamic_per_tensor_scaled_fp8_quant, torch.ops._C.dynamic_scaled_fp8_quant)
