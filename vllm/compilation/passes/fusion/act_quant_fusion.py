...
FUSED_OPS: dict[QuantKey, OpOverload] = {
    ...
    kFp8DynamicTokenSym: torch.ops.vllm_helion.silu_and_mul_dynamic_per_token_quant.default,
}
...
class SiluMulDynamicPerTokenQuantPattern(ActivationQuantPattern):
    """
    Fusion for SiluMul+Fp8DynamicPerTokenQuant Pattern
    """
    ...
    def register(self, pm_pass: PatternMatcherPass) -> None:
        def pattern(
            ...
            result_silu_mul = self.silu_and_mul_matcher(input)
            return self.quant_matcher(result_silu_mul)
...
class ActivationQuantFusionPass(VllmPatternMatcherPass):
    ...
    def __init__(self, config: VllmConfig) -> None:
        ...
        pattern_silu_mul_dynamic_per_token_fp8 = SiluMulDynamicPerTokenQuantPattern()
        pattern_silu_mul_dynamic_per_token_fp8.register(self.patterns)
