...
class ColumnParallelLinear(LinearBase):
    ...
    def forward(
        ...
        # Matrix multiply.
        assert self.quant_method is not None
        output_parallel = self.quant_method.apply(self, input_, bias, use_helion=use_helion)
...
class RowParallelLinear(LinearBase):
    ...
    def forward(
        ...
        output_parallel = self.quant_method.apply(self, input_parallel, bias_, use_helion)
