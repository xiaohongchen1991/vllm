...
MODELS=(
    # "AzatAI/Qwen3.8-27B-FP8-dynamic:1"
    # "Freaksterz/Qwen3.8-27B-SmoothQuant-W8A8-INT8:1"
    # "Qwen/Qwen3.8-27B-FP8:1"
    # "RedHatAI/Qwen3-1.7B-FP8-dynamic:1"
    # "RedHatAI/Qwen3-4B-FP8-dynamic:1"
    # "RedHatAI/Qwen3-8B-FP8-dynamic:1"
    # "RedHatAI/Qwen3-14B-FP8-dynamic:1"
    # "RedHatAI/Qwen3-32B-FP8-dynamic:1"
    "nytopop/Qwen3-1.7B.w8a8:1"
    # "RedHatAI/Qwen3-4B-Instruct-2507-quantized.w8a8:1"
    # "nytopop/Qwen3-8B.w8a8:1"
    # "nytopop/Qwen3-14B.w8a8:1"
    # "ramblingpolymath/Qwen3-32B-W8A8"
    # "Qwen/Qwen3-1.7B-FP8:1"
    # "Qwen/Qwen3-4B-FP8:1"
    # "Qwen/Qwen3-8B-FP8:1"
    # "qwen/Qwen3-14B-FP8:1"
...
run_one() {
    ...
    local extra=()
    # Helion linear kernels quantize inline, so keep the standalone quant_fp8
    # custom op out of the graph.
    [[ "$backend" == "helion" ]] && extra=(
        --linear-backend helion
        --compilation_config.custom_ops '["-quant_fp8"]'
    )
    ...
    MODEL="$model" PORT="$PORT" ./bench.sh >>"$bench_log" 2>&1
